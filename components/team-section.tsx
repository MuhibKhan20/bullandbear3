    ...
    <section ref={sectionRef} className="relative py-16 bg-white border-t border-black/5 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        <div className={`text-center mb-20 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-10'}`}>
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-gray-50 border border-black/10 text-muted-foreground text-xs font-bold tracking-widest uppercase mb-4">
          ...
          <div className="flex flex-wrap justify-center gap-8">
            {team.map((member, i) => (
              <div
                ...
                className={`group relative w-full max-w-[280px] aspect-[3/4] bg-white border-2 border-black/10 rounded-xl overflow-hidden hover:border-neon-green/50 transition-all duration-700 cursor-pointer ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'}`}
              >
                {/* Scanline Effect */}
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center p-8 bg-white group-hover:opacity-0 transition-opacity duration-700 z-10">
                  {/* Name in large bold */}
                  <div className="text-6xl font-black tracking-tighter text-black mb-4 text-center leading-none">
                    {member.name}
                  </div>
                  ...
                  <div className="w-full max-w-[200px] space-y-3">
                    <div className="flex items-center justify-between border-t border-b border-black/20 py-3">
                  ...
                  {/* Decorative elements */}
                  <div className="absolute top-6 left-6 w-12 h-12 border-t-2 border-l-2 border-black/20" />
                ...
                <div className="absolute inset-x-0 bottom-0 opacity-0 group-hover:opacity-100 transition-opacity duration-700 z-30">
                  ...
                  <div className="relative p-6 space-y-2">
                    ...
                    <div className="text-3xl font-black tracking-tighter text-black drop-shadow-2xl">{member.name}</div>
